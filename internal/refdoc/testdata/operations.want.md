...
| Status | Description | Body | Headers |
| --- | --- | --- | --- |
| `200` | One page of items. | [ItemList](/reference/api/reporting-api-schemas#itemlist) | none |
...
| Status | Description | Body | Headers |
| --- | --- | --- | --- |
| `200` | The batch was processed. | [ItemList](/reference/api/reporting-api-schemas#itemlist) | none |
| `413` | The batch carried more items than one call takes. | `application/problem+json` | none |

### `PUT /api/v1/items/{cloud}`

Replace the items of one cloud

Stores the items of the cloud, replacing whatever stood there. It declares no credential of its own and takes the document's.
...
| Status | Description | Body | Headers |
| --- | --- | --- | --- |
| `201` | The items as they now stand. | [ItemList](/reference/api/reporting-api-schemas#itemlist) | `Location` |
| `400` | The request failed. The body says how. | `application/problem+json` | none |
